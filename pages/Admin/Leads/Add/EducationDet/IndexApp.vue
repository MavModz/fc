...
<template>
        ...
        <div id="scrollableDiv" class="education-course-details" ref="scrollableDiv">
          <div class="education-course-details-conatiner-1" v-if="lead.primary">
            <DataTable :value="lead.primary" tableStyle="min-width: 50rem">
              <Column header="Organization Name" field="org_name"></Column>
              <Column header="Board" field="board"></Column>
              <Column header="Pursuing" field="pursuing"></Column>
              <Column header="Passing Year" field="passing_year"></Column>
        ...
        <div id="scrollableDivp" class="education-course-details" ref="scrollableDivp">
          <div class="education-course-details-conatiner-1" v-if="lead.professional && lead.professional.length>0">
            ...
            <DataTable :value="lead.professional" tableStyle="min-width: 50rem">
              <Column header="Organization Name" field="org"></Column>
              <Column header="University Name" field="uni"></Column>
              <Column header="Pursuing" field="pursuing"></Column>
              <Column header="Passing Year" field="passing_year"></Column>
              <Column header="Stream" field="stream"></Column>
              <Column header="CGPA/Points/Grade" field="cgpa"></Column>
              <Column header="Action">
                <template #body="{ data }">
  ...
  <Dialog v-model:visible="addPrimaryModal" modal header="Add Primary Education Details" :draggable=false>
    <FormKit type="form" @submit="addPrimary">
      <div class="">
        <label class="leads-label-assign-add">Organization Name</label><br>
        <FormKit validation="required" name="org_name" id="update-events-drpsem-add" type="text" placeholder="Organization name" validation-label="Organization name"/>
      </div>
      ...
      <div class="mb-3">
        ...
        <FormKit validation="required" type="date" id="update-events-drpsem-add" name="date_Time" validation-label="Passing Year"/>
      ...
      <div class="">
        ...
        <FormKit validation="required" name="status" id="update-events-drpsem-add" type="text" placeholder="Status" />
      </div>
  ...
  <Dialog v-model:visible="addProfessionalModal" modal header="Add Professional Course Details" :draggable=false>
    <FormKit type="form" @submit="addProfessional">
      <div class="">
        <label class="leads-label-assign-add">Organization Name</label><br>
        <FormKit validation="required" name="org" id="update-events-drpsem-add" type="text" placeholder="Organization name" validation-label="Organization name"/>
      </div>
      <div class="leads-addjb-dtls-mdl">
        <div class="">
          <label class="leads-label-assign-add">University</label><br>
          <FormKit validation="required" name="uni" id="update-events-drpsem-add-btw" type="text" validation-label="University"
            placeholder="------" />
        </div>
        <div class="">
      ...
      <div class="mb-3">
        <label class="leads-label-assign-add">Passing Year</label><br />
        <FormKit validation="required" type="date" id="update-events-drpsem-add" name="Passing Year" validation-label="Passing Year"/>
      </div>
      <div class="">
      ...
      <div class="">
        ...
        <FormKit validation="required" name="cgpa" id="update-events-drpsem-add" type="text" placeholder="CGPA/Points/Grade" />
      </div>
      <div class="modal-footer-section">
        <button type="submit" class="btn-btn-dle-appt">Submit</button>
      </div>
