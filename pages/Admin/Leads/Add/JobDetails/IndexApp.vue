  ...
  <Dialog v-model:visible="addModal" modal header="Add Job Details" :draggable=false>
    <FormKit type="form" @submit="addJob">
      <div class="">
        ...
        <FormKit validation="required" name="company" id="update-events-drpsem-add" placeholder="Organization name" type="text" validation-label="Organization name"/>
      </div>
      <div class="leads-addjb-dtls-mdl">
        ...
        <div class="">
          ...
          <FormKit validation="required" name="ctc" id="update-events-drpsem-add" type="text" placeholder="CTC" validation-label="CTC"/>
        </div>
      </div>
      <div class="mb-3">
        <label class="leads-label-assign-add">Starting Year</label><br />
        <FormKit validation="required" type="date" id="update-events-drpsem-add" name="start" validation-label="Starting date"/>
      </div>
      <span>
        <div class="mb-3">
          <label class="leads-label-assign-add">Ending Year</label><br />
          <FormKit validation="required" type="date" id="update-events-drpsem-add" name="end" validation-label="Ending date"/>
        </div>
      </span>
