...
<template>
  <div class="personal-details-container">
    ...
    <div class="refusal-details-section">
      ...
      <div class="personal-details-row-1" v-if="lead.refusal">
    ...
    <div class="family-details-section">
      <div class="family-details-heading-section">
        <div class="family-details-heading">
          <span class="fs-4 fw-semibold text-[#808080]">Family Details</span>
        </div>
  ...
  <Dialog v-model:visible="addModal" modal header="Add Family Details" :draggable=false>
    <FormKit type="form" @submit="addFamily">
      ...
      <div class="mb-3">
        ...
        <FormKit validation="required" type="date" id="update-events-drpsem-add" name="dob"  :max="new Date().toISOString().split('T')[0]"/>
      </div>
      <div class="">
        ...
        <FormKit validation="required" name="phone" id="update-events-drpsem-add" type="tel"
          placeholder="Phone Number" @keypress="restrictToNumbers"/>
      </div>
      <div class="">
  ...
  <Dialog v-model:visible="addRefModal" modal header="Refusal Details" :draggable=false>
    <FormKit type="form" @submit="addrefusal">
      ...
      <div class="leads-addjb-dtls-mdl">
        <div class="add-leads-persn-dropdd">
          ...
          <FormKit validation="required" name="year" id="update-events-drpsem-add" type="select" :options="generateYears()" placeholder="------" />
        </div>
      </div>
