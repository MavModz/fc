        ...
        <table class="table-recmd-dsnn">
          ...
          <tbody>
            ...
            <tr v-else class="url-generate-back" v-for="(item, index) in forms" :key="index">
              ...
              <td><span class="view-link divhover" @click="this.$router.push(`/admin/forms/response/${item._id}`)"><i class="bi bi-eye" style="font-size: 1rem;"></i>
                  View</span>
              </td>
              ...
              <td class="" align="right">
                <div class="dropdown-center">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li @click="this.$router.push(`/admin/forms/updateform/${item._id}`)">
                      <a class="dropdown-item">
                        Edit Form Fields
                      </a>
                    </li>
                    <li @click="deleteForm(item._id)">
                      <a class="dropdown-item">
                        Delete
                      </a>
                    </li>
