<template>
  <div class="form-section">
    ...
    <div class="grid">
      ...
      <div class="input-group">
        ...
        <div class="select-option cursor-pointer">
          <select v-model="listService.country" class="custom-select cursor-pointer" required
            @click="fetchAdminCountries('Study Visa')">
      ...
      <div class="input-group">
        <label>College/University Logo</label>
    ...
    <div class="input-group">
      ...
      <div class="input-container ">
        <input type="text" id="location" class="location-input" placeholder="----------------------------"
    ...
    <div class="input-gp">
      ...
      <div class="study-visa-description-block">
        <QuillEditor :modules="modules" ref="qhtml" class="mb-5" style="height:200px" />
          ...
          <tr v-for="(item, index) in program_list">
            ...
            <td>
              <div class="action-icons">
                <img src="public/img/png/edit-blue (1).png">
    ...
    <div class="form-sec">
      <div class=grid>
        ...
        <div class="input-group">
          ...
          <input type="text" placeholder="----------------------" required v-model="listService.living_expenses">
        </div>
        <div class="input-group">
        ...
        <div class="input-group">
          ...
          <input type="text" placeholder="------------" v-model="listService.minimum_language_score" required>
        </div>
      </div>
  ...
  <div>
    <div class="testimonial-section mt-4">
      ...
      <div v-if="listService.testimonilas.length > 0" class="card-container max-W-[350px]  whitespace-nowrap overflow-x-auto">
        ...
        <div class="relative inline-block">
          ...
          <div class="upload-card absolute mt-2 right-0 z-10" v-if="addMediaOpen">
            <div class="upload-option relative" @click="addMediaOpen = false">
              ...
              <input class="opacity-0 absolute top-0 h-[60px] w-[150px]"   accept="image/*" type="file" @change="handleMediaChange" />
            </div>
    ...
    <div class="buttons mt-4 d-flex align-items-center gap-[14px]">
      ...
      <button @click="submitColleageStudyVisa" class="Submit-btn d-flex align-items-center bg-[#ff5757]"
        :disabled="loading">
      ...
      <div class="form-sec">
        ...
        <div class="grid mt-3">
          ...
          <div class="input-group">
            ...
            <!-- <FormKit type="datetime-local" class="update-event-dte" name="end_date_Time"
                v-model="program.course_end_date" @change="validateDates"
                style="padding: 1.25rem 1.5rem ; border: 1.19px solid #D5D2DC; border-radius: 10px; " /> -->
          </div>
          <div class="input-group">
          ...
          <div class="input-group">
            ...
            <input type="text" placeholder="------------" v-model="program.application_fee" inputmode="numeric"
          ...
          <div class="input-group">
            ...
            <input type="text" placeholder="------------" v-model="program.annual_tution_fee" required
        ...
        <!-- <div class="input-group">
            <label>Intakes Months</label>
            <input type="text" placeholder="------------" v-model="program.intakes_months">
          </div> -->
        ...
        <div class="input-gp">
          ...
          <div class="study-visa-description-block">
            <QuillEditor :modules="modules" ref="qPro_html" class="mb-5" style="height:200px" />
            <p v-if="validationErrors.overview" class="!text-red-500 text-sm mt-1">
              {{ validationErrors.overview }}
            </p>
          </div>
    ...
    <div class="update-screen">
      <div class="update-wrapper">
        ...
        <FormKit type="form" :submit-label="testimonilasupdate ? 'Update Achievement' : 'Add Achievement'"
          @submit="handleTestimonilasSubmit">
            ...
            <div class="update-events-left col-lg-8">
              ...
              <div class="update-events-1stfrm">
                ...
                <div class="update-events-1stdrop h-[150px]">
                  <QuillEditor :key="editorKey" :modules="modules" toolbar="full" ref="testimonialhtml" class="mb-5"
...
export default {
  ...
  methods: {
    ...
    //   }
    //   console.log(this.mediaAllImagePic)
    ...
    //     .then(results => {
    //       this.listService.media_list.push(...results);
    //       payload.media_list= this.listService.media_list
    //       console.log("All images uploaded:", this.listService.media_list);
    //     })
    //     .catch(error => {
    //       console.error("Image upload failed:", error);
    //     });
    // console.log(this.listService.media_list)
    //   try {
    //     this.loading = true;
    ...
    //       this.resetForm();
    //       this.$router.push({
    //         path: '/admin/Categories/Study Visa'
    //       });
    //       this.loading = false;
    //     }
    //   } catch (error) {
    ...
    addIntakeMonth() {
      ...
      // if (!Array.isArray(this.intakes_months)) {
      //   this.intakes_months = [];
      // }
