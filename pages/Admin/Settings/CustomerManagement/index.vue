<template>
  ...
  <div class="tab-navigation">
    <span class="isbuttonTrue"><NuxtLink class="text-[#A1A5B7]" to="/admin/settings/LeadManagement" >Lead Management Settings</NuxtLink></span>
...
export default {
  components: {Payment, Hierarchy, Messaging},
  data(){
    return{
