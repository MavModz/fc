                    ...
                    <div v-if="InstitData && hasValidData" class="parent-Intitue-level pt-[15px]">
                        <div class="trapezoid">
                            <div class="trapezoid-content d-flex justify-between items-center w-[100%]">
                                <span class="text-[#fff]">Open Leads</span>
                                <span class="text-[#fff]">{{ InstitData['Open Lead'] || 'N/A' }}</span>
                            </div>

                        </div>
                        <div class="trapezoid-2nd ">
                            <div class="trapezoid-content d-flex justify-between items-center w-[100%]">
                                <span class="text-[#fff]">In Progress</span>
                                <span class="text-[#fff]">{{ InstitData['In Progress'] || 'N/A' }}</span>
                            </div>
                        ...
                        <div class="trapezoid-3nd ">
                            <div class="trapezoid-content d-flex justify-between items-center w-[100%]">
                                <span class="text-[#fff]">Hot Leads</span>
                                <span class="text-[#fff]">{{ InstitData['Hot Lead'] || 'N/A' }}</span>
                            </div>
