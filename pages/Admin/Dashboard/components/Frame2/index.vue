                ...
                <div class="div-2">
                    <div class="col-sm-12 d-flex justify-content-between align-items-center">
                        ...
                        <!-- <BootstrapIcon name="calendar" class="calendar" style="cursor: pointer;"
                            @click="openCalendar" /> -->
                            <button class="label-2" style="cursor: pointer;" @click="openCalendar" >Today <i class="bi bi-chevron-down"></i></button>
                    </div>
                    <p class="p">
...
const Graph = defineAsyncComponent(() => import('./GraphBar/index.vue'))
