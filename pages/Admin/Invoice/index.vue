    ...
    <section class="user-details">
        ...
        <div class="languages pb-[25px]">
            <div class="gallery-media-action">
                ...
                <div class="admin-invoice-generate-invoice hover-effect cursor-pointer" @click="sendaddpayment('abc')">
                    ...
                    <tbody>
                        ...
                        <tr v-for="i in invoice_list">
                            ...
                            <td>
                                ...
                                <span class="payment-emi" v-if="i.emi.length > 0"> {{ getPaidEmiCount(i.emi) }} /{{
                                    i.emi.length }}</span>
                            </td>
                            <td>
                            ...
                            <td>
                                <!-- <div class="btn-group">
                                    <span class="td-btn">
                                        <NuxtLink :to="`/admin/invoice/component/fullpayment/abcdef`">
