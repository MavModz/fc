  ...
  <div class="col-lg-12 margin-top" style="height: auto">
    ...
    <div class="cards mt-3" style="height: 42vh">
      <div class="input-field">
        <div class="d-flex flex-wrap gap-x-[35px] gap-y-[20px] achiever-list">
          <div class="achiever" v-for="(i, index) in all_images" :key="i">
          <div class="tourist-media-size">
            <img class="h-[100%] w-[100%] object-cover rounded-xl" :src="i" style="height: 150px" />
          </div>
...
export default {
  ...
  methods: {
    ...
    async icon_uploadImage() {
      this.all_images.push(await uploadImage(this.id, this.icon_selectedImage));
