  ...
  <div class="stepper-container">
    ...
    <div class="step-content">
      <component :is="currentComponent"
       :formData="formData"
        ref="currentChildComponent"
        @basicInfoSubmit="handleBasicInfoSubmit"
         @jobDetailsSubmit="handleJobDetailsSubmit"
         @submit="submitCurrentStep"
         />
    </div>

    <div class="step-navigation">
      <button class="prevs-stepperbtn"  v-if="activeStep !== 1 && activeStep !== 4"  @click="goToStep(activeStep - 1)">Previous</button>
