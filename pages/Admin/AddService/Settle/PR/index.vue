<template>
    <div class="form-section">
            ...
            <div class="input-group">
                ...
                <div class="select-option cursor-pointer">
                    <select v-model="listService.country" class="custom-select cursor-pointer" required
                        @click="fetchAdminCountries('Settle Abroad')">
        ...
        <div class="input-group">
            <label>PR Program Name</label>
            <div class="input-container ">
                <input type="text" id="location" class="location-input" placeholder="----------------------------"
                    v-model="pr_program_name" @keyup.enter="addProgram_name" />
                ...
                <tbody>
                    <tr v-for="(item, index) in program_list">
                        ...
                        <td>
                            ...
                            <span class="text-[#ff5757] font-bold underline  ml-2" v-if="item.program_province.length > 2">
    ...
    <div class="form-section mt-4">
        ...
        <div class="form-sec">
            ...
            <div class="input-gp">
                ...
                <div class="study-visa-description-block">
                    <ClientOnly>
                        <QuillEditor :modules="modules" ref="pr_qhtml" class="mb-5" style="height:200px" />
                    </ClientOnly>
                    <p v-if="validationErrors.overview" class="!text-red-500 text-sm mt-1">
                        {{ validationErrors.overview }}
                    </p>
 ...
 <label class="mt-5">Additional Services</label>
    ...
    <div>
        ...
        <div v-if="listService.tabs.length > 0" class="custom-section mt-4">
            ...
            <div v-for="(tab, index) in listService.tabs" :key="index" class="mt-[25px]">
                <!-- <div class="input-row-1 d-grid align-items-center gap-[31px]"> -->
                    <div class="input-group">
    ...
    <Dialog v-model:visible="infoModals" modal @hide="resetprogramForm" header="Program Details"
                ...
                <div class="input-group">
                    ...
                    <div class="input-container ">
                        <input type="text" id="location" class="location-input"
                            placeholder="----------------------------" v-model="program_province"
        ...
        <div class="text-right mt-4">
            ...
            <Button  @click="() => programsupdate ? handleupdate() : handleSubmit()"
                class="update-event-change" type="submit" :label="programsupdate ? 'Update' : 'Submit'"
                icon="pi pi-save" />
                                ...
                                <div class="update-events-1stdrop h-[150px]">
                                    <ClientOnly>
                                        <QuillEditor :key="editorKey" :modules="modules" toolbar="full"
                                            ref="testimonialhtml" class="mb-5" v-model="achievers.description" />
                                    </ClientOnly>
    ...
    methods: {
        ...
        validateFields() {
            ...
            if (!this.listService.program_name_list || this.listService.program_name_list.length === 0) {
                this.validationErrors.program_name_liste = 'Program name is required';
            }
