      ...
      <div class="cards left-side-card">
        <div class="card-body">
         ...
         @click="$refs.modals.OverviewModal = true" 
            ...
            > -->
            <span class="edit_btn divhover" @click="profile_update">
        ...
        <div class="card-body">
          <div class="card-title">
            <h4>Categories</h4>
            <span class="edit_btn divhover" @click="category_update">
          ...
          <div v-if="filteredServices.length" class="relative">
            ...
            <Carousel class="row" :value="filteredServices" :responsiveOptions="responsiveOptions" :numVisible="4"
              ...
              <template #item="i" style="height: 215px" >
                ...
                <div v-if="i.data.flag" class="flex flex-col items-center shadow-sm rounded-lg mx-2 py-5 my-3 category-crousel-business">
        ...
        <div class="card-body">
          <div class="card-title">
            ...
            <NuxtLink v-if="company.video_url" to="/admin/gallery/video" class="text-[#000]">
              <span class="edit_btn divhover">
                <img src="/img/svg/dark-edit.svg" alt="" />&nbsp;Edit
              </span>
            </NuxtLink>
          ...
          <AddVideo ref="addVideo" @refreshApi="reloadloc()" />
      ...
      <div class="cards">
        <div class="card-body">
          ...
          <input class="mb-3 cursor-default" type="text" v-model="company.company_email" placeholder="Official Email ID"
            :readonly="isReadOnly" />
            <input v-if="company.whatsapp_number && !company.whatsapp_number_isCheck" class="mb-3 cursor-default" type="text" v-model="company.whatsapp_number" placeholder="Official Email ID"
            :readonly="isReadOnly" />
        </div>
      </div>
      <div class="cards">
        <div class="card-body">
          <div class="card-title">
            ...
            <span class="edit_btn divhover" @click="location_update">
              <NuxtImg src="/img/svg/dark-edit.svg" alt="" />&nbsp;Edit
            </span>
          </div>
          <input class="my-3 cursor-default" type="text" v-model="company.pincode" placeholder="Pin Code*" :readonly="isReadOnly" />
          <input class="mb-3 cursor-default" type="text" v-model="company.city" placeholder="City *" :readonly="isReadOnly" />
          <input class="mb-3 cursor-default" type="text" v-model="company.state" placeholder="State *" :readonly="isReadOnly" />
          <textarea class="mb-3 cursor-default" type="text" v-model="company.address" placeholder="Address*" :readonly="isReadOnly" />

          <div class="card-title">
            <h5>Map</h5>
            <!-- <span class="edit_btn divhover" @click="$refs.modals.initMap()"><img src="/img/svg/dark-edit.svg"
                alt="" />&nbsp;Edit</span> -->
            <span class="edit_btn divhover" @click="location_update"><img src="/img/svg/dark-edit.svg"
                alt="" />&nbsp;Edit</span>
          </div>
          <div class="map">
        ...
        <div class="card-body">
          <div class="card-title">
            ...
            <!-- <span class="edit_btn divhover" @click="$refs.modals.TimingsModal = true"><img src="/img/svg/dark-edit.svg"
                alt="" />&nbsp;Edit</span> -->
            <span class="edit_btn divhover" @click="opening_hours_update"><img src="/img/svg/dark-edit.svg"
                alt="" />&nbsp;Edit</span>
          </div>
...
export default {
  ...
  methods: {
    ...
    async primaryvideo() {
      try {
        const response = await adminGet(`/company-primary-video`);
