<template>
    ...
    <div class="seminar-screen">
        <div class="seminar-wrapper">
            ...
            <div class="seminar-interested d-flex justify-content-between flex-wrap pt-[30px] gap-x-[10px] gap-y-[20px] relative">
            ...
            <div class="event-description-design mt-5">
                ...
                <div class="webinar-meet">
                        <span class="web-meet-line d-flex gap-3 align-items-center pb-3">
                            <p>Event Link</p>
                            <span class="bg-[#ff5757] text-[#fff] px-2 py-1 rounded-[8px] text-[14px]">{{ event?.event_type }}</span>
                        </span>
