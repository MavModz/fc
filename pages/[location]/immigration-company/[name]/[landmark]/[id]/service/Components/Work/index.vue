      ...
      <template v-else-if="visibleAchievers?.length > 0">
        <div v-for="(i, index) in visibleAchievers" :key="index" class="rounded-lg relative pr-2">
          <div  class="nuxt-link-hover">
            ...
            <span class="image-hovershow w-[25px] h-[25px]">
              <img src="/img/png/redirect.png" alt="">
            </span>
          </div>
          <div>
            <span class="text-[#454056] font-bold text-[18px] leading-[50px]">{{ i.work.jobCategory_name }}</span>
            <p class="text-[#666276] font-normal text-[12px]" v-html="truncateOverview(i.overview)"></p>
            <div class="flex justify-between items-center gap-2 flex-wrap">
              <div class="flex items-center gap-2">
                <img class="w-[40px] h-[40px] rounded-full object-cover mt-[10px]" :src="i.work.logo" alt="" />
                <span
              ...
              <div class="m-0 font-bold">
                <span class="text-[#ff5757]">₹</span><span class="text-[#3C3C3C]">{{ i.work.salary }}</span> - <span
                  class="text-[#ff5757]">₹</span><span class="text-[#3C3C3C]">25k</span>
              </div>
            </div>
          </div>
        </div>
