...
useHead({
  ...
  meta: [
    { name: 'description', content: `${company?.value?.overview} ${company?.value?.address} Best Immigration consultant in ${company?.value?.city}  Find and Consult` || 'Default Description' },
