...
<template>
  <div class="overview_box">
    <div class="overview_top">
      <div class="flex justify-between items-center flex-wrap pb-3">
        <div class="">
          <h3 class="title_25 font-semibold">About {{ company?.company_name }}</h3>
        </div>
        <!-- <CompanyWishlists /> -->
      </div>
    </div>
  ...
  <div v-for="i in videos">
    <div v-if="i.primary" class="video_box pt-[20px]">
      <div class="row">
        <div class="col-12">
          <h3 class="title_25 font-semibold">Featured Video of {{ company?.company_name }}</h3>
  ...
  <div v-if="company?.services.length > 0" class="company-services-parent pt-[20px] relative">
    ...
    <h3 class="title_25 font-semibold">Services of {{ company?.company_name }}</h3>
  ...
  <div class="countries_box pt-[20px] pb-2">
    <div class="row">
      <div class="col-12">
        <h3 class=" company-country-heading title_25 font-semibold">Countries {{ company?.company_name }} deals in</h3>
