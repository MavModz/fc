  ...
  <div class="contact-card">
    ...
    <div class="flex justify-between items-center">
      ...
      <div @click="toggleButton('appointment')" class="py-[15px] text-center cursor-pointer font-bold w-full"
        :class="clickedButton === 'appointment' ? 'border-bottoms text-[#F22C15]' : 'bg-[#FAFAFA] text-[#74767E] border-gray-bottom'" v-if="isAppointment">
        ...
        <div class="contact-card-form">
          <FormKit type="form" @submit="addLead">
            ...
            <div class="input-field">
              <input v-model="selectName" type="text" name="name" placeholder="Your name*" class="form-control" />
              <p v-if="nameError" class="error-message">Name is required</p>
            </div>

            <!-- Email Input -->
            <div class="input-field">
              <input v-model="selectEmail" type="email" name="email" placeholder="Email*" class="form-control" />
            ...
            <!-- Message Textarea -->
            <div class="input-field">
              <input v-model="selectText" type="textarea" name="enquiry_message" placeholder="Message"
