...
<template>
    <div class="card-section">
        ...
        <div class="section-1 mt-1 institute-profile title d-flex justify-content-between align-items-center">
            <div class="left-section-1 d-flex align-items-center gap-2">
                <div v-if="company?.business_license_number" class="licence-number">
                    <h6>Licence Number <span>{{ company?.business_license_number }}</span></h6>
                </div>
        ...
        <div class="section-1 mt-1 institute-profile-location title d-flex justify-content-between align-items-center gap-5">
    ...
    methods: {
        ...
        async addWishlists() {
            if (this.wish) {
                ...
                this.wish = true;
                successAlert("Whishlist Add Successfully")
            }
        },
