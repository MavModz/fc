...
<template>
  ...
  <div class="container-blg-down py-lg-5 py-2">
    ...
    <div class="recent-blogs ">
      <div class="blg">
        <NuxtLink :to="'/blogs/' + i._id" v-for="i in data" class="semi-blog rounded-xl flex flex-col gap-1">
...
export default {
  ...
  async setup() {
    ...
    let blog = (await homeGet(`/home-view-blogs/${route.params.id}`)).data.data;
