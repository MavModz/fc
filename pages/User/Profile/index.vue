            ...
            <div id="border-gigma">
              <div class="style-formkit-inpt">
                <div class="first-inpt-frmkit">
                  <FormKit type="text" class="custom-clas-frmkisw" label="Full Name" v-model="user.name" name="name"
                  ...
                  <div class="first-inpt-frmkit relative">
                    ...
                    <div v-else>
                      <FormKit type="text" label="Phone Number" v-model="user.phone" name="phone"
                        validation="required|length:10" :maxlength="10" @keypress="restrictToNumbers"
                ...
                <div class="first-inpt-frmkit relative">
                  ...
                  <div v-else>
                    <FormKit type="text" label="Aadhar Number" v-model="user.aadhar" name="aadhar" validation="required"
                      ...
                      @keypress="restrictToNumbers" :disabled="!isEditable" />
              ...
              <div class="style-formkit-inpt">
                <div class="first-inpt-frmkit relative">
                  <FormKit type="text" label="Address" v-model="user.address" name="address" validation="required"
  ...
  methods: {
    ...
    async deleteAccount() {
      if (await deleteConfirm("Do You Want to delete your account")) {
        warningAlert("Feature comming soon!");
      }
    },
