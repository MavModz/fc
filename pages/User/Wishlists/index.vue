<template>
  <div class="gallery-container p-4">
    ...
    <div class="whishlist-filter-btn-area flex flex-wrap gap-3">
      ...
      <!-- <button class="btn-normal" :class="{ active: selectedButton === 'services' }" @click="selectTab('services')">
        Services
      </button>
      <button class="btn-normal" :class="{ active: selectedButton === 'events' }" @click="selectTab('events')">
        Events
      </button> -->
    </div>
