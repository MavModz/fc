<template>
    <div class="document-card col-sm-3 m-0">
        ...
        <div class="agreement-profile-container flex items-center gap-2 pt-3">
            <NuxtImg class="rounded-full" :src="companyLogo || 'https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_1280.png'" width="24" height="24" />
        ...
        <div class="d-flex flex-wrap justify-content-between mt-4">
            <div class="d-flex flex-wrap justify-content-between align-items-center gap-2"
                ...
                <div class="d-flex justify-content-between gap-2">
                    <span class="btn-span cursor-pointer" @click="triggerView"><img src="/img/svg/eye.svg" alt="" /></span>
