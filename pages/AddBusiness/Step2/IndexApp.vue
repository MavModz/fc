    ...
    <FormKit type="form" :value="company" @submit="submitForm">
      <div class="row">
        ...
        <div class="col-lg-6 pt-5 mb-sm-0 pr-[45px] pl-[40px]">
          <div class="row">
            <div v-if="!company.is_claim" class="col-sm-6 mb-3 mb-sm-0">
              ...
              <div id="register-phne-backgrd-onbrd" class="rounded-3 pt-5 bg-body-tertiary">
                ...
                <div class="form-group pt-4 pt-md-0 pb-3 relative">
                  ...
                  <FormKit v-if="phone_verified" @keydown="changeInput('e')" name="phone" type="text"
                    @keypress="restrictToNumbers" :maxlength="10" validation="required|length:10"
                  ...
                  <div v-if="!contain_error">
                    <span v-if="!phone_verified" @click="resendPhoneCode" class=" verify-position verify-btn">Verify
                      Now</span>
                ...
                <div class="custom-checkbox">
                  ...
                  <span class="ml-[8px] text-[#696f79]">Use This as Official WhatsApp Number / </span> <span
                    @click="addNewNumber" class="text-[#ff5757] underline">+ add new</span>
                </div>
                ...
                <div class="form-group pt-4 pt-md-0 pb-3 relative">
                  ...
                  <FormKit v-if="email_verified" @keydown="changeInput('e')" name="company_email" type="email"
                    validation="required|email" v-model="company.company_email" placeholder="Enter Your Email ID"
                  ...
                  <FormKit v-if="!email_verified" @keydown="changeInput('e')" name="company_email" type="email"
                    ...
                    :disabled="email_verified" validation-label="Company email" />
                  <div v-if="!contain_error">
                    <span v-if="!email_verified" @click="resendEmailCode"
                      class="absolute verify-position verify-btn">Verify Now</span>
  ...
  methods: {
    ...
    async submitForm(v) {
      ...
      if (this.icon_url == 'https://i.etsystatic.com/14605561/r/il/f5e98d/1875743584/il_570xN.1875743584_s4ee.jpg') {
        ...
        errorAlert('Pleased Verify Your Phone');
      } else if (!this.email_verified) {
        errorAlert('Pleased Verify Your Email');
      } else {
        // this.loading = true;
        if (!this.update) {
