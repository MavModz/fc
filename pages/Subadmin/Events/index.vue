      ...
      <template #header>
        <div class="Your-events-1stbox mb-3">
          <div class="Your-events-1stbox-search">
            ...
            <div class="your-events-addbtn" v-if="userData.user.permission.events.add">
              <NuxtLink to="/subadmin/events/add">
            ...
            <div class="your-events-1stbox-contentdetails">
              ...
              <div class="your-events-1stbox-content-start">
                ...
                <div class="tooltip-gallery-cont-event">
                  ...
                  <NuxtLink :to="'/subadmin/Events/Update/' + item._id" v-tooltip.top="'Edit '" class="icon1">
                  ...
                  <div class="tooltip-gallery-cont-blog">
                    <div class="dropdown-center">
                      ...
                      <ul class="dropdown-menu">
                        <li v-if="userData.user.permission.events.delete">
                          <a class="dropdown-item" @click="deleteEvent(item)">
                            <BootstrapIcon name="trash" class="icon5" />Delete
                          </a>
                        </li>
                        <li v-if="userData.user.permission.events.edit">
                          <a class="dropdown-item" @click="editEvent(item)">
                            <BootstrapIcon name="pencil-square" class="icon5" />Edit
                          </a>
                        </li>
                        <li v-if="userData.user.permission.events.view">
                          <a class="dropdown-item" @click="viewEvent(item)">
                            <BootstrapIcon name="star" class="icon5" />View Event
                          </a>
                        </li>
                      </ul>
                    </div>
              ...
              <div class="your-events-responses">
                <div class="your-event-resinside divhover2">
                  ...
                  <div class="your-event-resinside-text">
                    <NuxtLink :to="'/subadmin/events/response/' + item._id">
                      <span>
...
export default {
  ...
  methods: {
    ...
    async editEvent(i) {
      ...
      this.$router.push({
        path: `/subadmin/events/update/${i._id}`,
        state: { fromForm: true },
      });
    },
    async viewEvent(i) {
