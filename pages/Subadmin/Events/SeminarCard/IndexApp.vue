<template id="v-carousel"><span class="crd-blg-you">
    ...
    <div class="card-carousel-wrapper">
        <div v-if="showNavigation" class="card-carousel--nav__left" @click="moveCarousel(-1)" :disabled="atHeadOfList">
        </div>
                    ...
                    <div id="card-reltt" class="card-carousel--card" v-for="item in items" :key="item.title">
                        <div v-if="item.event_type == 'Webinar'">
                            <div class="card-imgg-rel">
                                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTUmuGDc43ijbehWFuXMKhnP6GDEgQYnju3Rg&usqp=CAU"
                                    alt="image" />
                                    ...
                                    <div class="col-sm-12 name">
                                        <div class="sem-card-stl">
                                            ...
                                            <span class="text-secondary">
                                                ...
                                                <p class="seminar-time-web">{{ item.start_time }} - {{ item.end_time }}
                                                </p>
        ...
        <div v-if="showNavigation" class="card-carousel--nav__right" @click="moveCarousel(1)" :disabled="atEndOfList">
        </div>
    </div>
</template>
