    ...
    <div class="leads-table-filtr-wrapper">
      ...
      <div class="leads-table-tble-chckbxfltr style-4">
        ...
        <div class="leads-table-filter-flx-new w-[100%]">
          <Calendar class="w-[100%] p-[10px]"v-model="filter.date" selectionMode="range" :manualInput="false" placeholder="select date range"/>
        </div>
      </div>
      ...
      <div class="leads-table-tble-chckbxfltr style-4">
        ...
        <div class="leads-table-filter-flx-new p-[10px]">
          <MultiSelect display="chip" v-model="filter.status" :options="leadstatus" optionLabel="label"
    ...
    submit() {
      ...
      if (this.filter.source.length > 0) {
        ...
        for (let i in this.filter.source) {
          f.source.$in.push(this.filter.source[i].value)
        }
      }
