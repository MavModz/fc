          ...
          <div class="card mb-3 border-radius">
            <div class="card-body" :class="{
              ...
              <div class="end-section">
                <a class="btn get-started" @click="getStarted(data)" role="button">Get Started</a>
              </div>
            </div>
      ...
      crmIntegrationModules: [
        {
          ...
          isUpcoming: false,
          crmIncuded: true,
          route: "/subadmin/settings/LeadManagement/WebHooks/FaceBook"
        },
        {
          id: 2,
          name: 'Google Sheet',
        ...
        },
        {
          ...
          name: 'Google AD’s',
          image: 'GoogleAds.svg',
          description: `Fetch leads from Google campaigns using Google Asset Form. 
          Add details in Custom CRM Integration, and it's ready to start instantly.`,
          isUpcoming: false,
          crmIncuded: true,
          route: "/subadmin/settings/LeadManagement/WebHooks/indexApp"
        },
        {
          id: 4,
          name: 'Custom Form',
          ...
          isUpcoming: true,
          crmIncuded: true,
          route: "/subadmin/Forms/GenerateForm"
        },
        {
          id: 5,
          ...
          isUpcoming: false,
          crmIncuded: true,
          route: '/subadmin/leads/view/LeadAutomation',
        ...
        },
        {
          ...
          isUpcoming: false,
          crmIncuded: true,
          route: "/subadmin/Leads/WordPress"
        },
      ]
    };
  },
