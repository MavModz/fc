<template>
  ...
  <Sidebar v-if="data" v-model:visible="offCanvas" header="Lead Profile"  position="right" style="width: 40vw;overflow: auto;padding: 10px;" class="lead-canvas">
            ...
            <div class="card">
              ...
              <div class="single-leads-teck-container">
                ...
                <span class="single-lead-ovre-cmprfle">
                    <p><NuxtLink :to="'/subadmin/leads/detail/'+data._id">View Complete Profile</NuxtLink></p>
                </span>
                <span>
