...
<template>
  <div class="languages">
    ...
    <div class="mt-5 lead-table" v-if="settings?.leadAutomation && settings2">
      ...
      <div v-if="subteam >= 0 && settings2[0].children[team].children.length>0 && settings2[0].children[team].children[subteam].children.length>0" class="name">
        <div class="auto-row-name">
          <div class="auto-col border-zero auto-name"><span>Name</span></div>
        </div>

        <div v-if="subteam >= 0" class="auto-row-name" v-for="i of settings2[0].children[team].children[subteam].children" :key="i._id">
          <div class="auto-col border-zero auto-checkbox">
            <label class="containers">
              <Checkbox v-model="selectedNames" :inputId="i.subadmin_id" name="employees" :value="i.subadmin_id" />
            </label>
          </div>
      ...
      <div v-if="subteam >= 0 && settings2[0].children[team].children.length>0 && settings2[0].children[team].children[subteam].children.length>0" class="selected-name">
        <div class="auto-row-name">
      ...
      <div v-if="subteam >= 0 && settings2[0].children[team].children.length>0 && settings2[0].children[team].children[subteam].children.length>0" class="sorting">
        <div class="auto-row-name">
