...
export default {
  ...
  methods: {
    ...
    //   this.loading = true;
    //   await adminPost(`/request-documents`, v).then(response => {
    //   })
    ...
    //     const base64Data = await this.convertToBase64(icon_selectedFile);

    //     // Generate a filename for the upload
    //     const filename = ;

    //     // Upload the file by passing base64 data to your upload function
    //     this.file_url = await uploadFileAdminE2(base64Data, filename);
    //   }
    // },
