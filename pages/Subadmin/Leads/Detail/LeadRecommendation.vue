    ...
    <div v-if="!loading && totalListing == 0" class="card bg-white border-0 rounded-10">
      <div class="card-body">
        <div class="text-center">
          ...
          <NuxtLink to="/admin/services" class="btn btn-danger py-2 px-4 text-decoration-none text-white mb-4">Add New
            Listing</NuxtLink>
        </div>
      </div>
    </div>
            ...
            <span class="frm-url-wid">
              <div class="mb-3">
                ...
                <FormKit validation="required" type="select" v-model="selectedService" name="selectedService"
                  placeholder="Select Service" @change="getListing()" :options="services" />
            ...
            <span class="frm-url-wid">
              <div class="mb-3">
                ...
                <FormKit validation="required" type="select" v-model="selectedListing" name="listing_id"
                  placeholder="Select Listing" id="form-url-inpt" class="form-select" :options="listing" />
              </div>
            </span>
          </div>
