<template>
  <div class="cnt">
    <div class="achievers-publs">
      ...
      <div class="achiever-add" v-if="userData.user.permission.achievers.add">
    ...
    <DataView :value="allAchievers" paginator :rows="8" :alwaysShowPaginator="false">
      <template #empty>
            ...
            <div class="card mb-4 shadow shadow-xs ">
              ...
              <div class="card-img-overlay">
                <div class="dropdown-center"
                  v-if="userData.user.permission.achievers.edit || userData.user.permission.achievers.delete">
                  <button class="dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                    <BootstrapIcon name="three-dots-vertical" class="icon2" />
                  </button>
                  <ul class="dropdown-menu">
                    <li v-if="userData.user.permission.achievers.delete">
                      <a class="dropdown-item" @click="deleteEvent(item)">
                        <BootstrapIcon name="trash" class="icon5" />Delete
                      </a>
                    </li>
                    <li v-if="userData.user.permission.achievers.edit">
