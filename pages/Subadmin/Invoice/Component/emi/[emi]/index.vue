                ...
                <div class="user-invoice-main-first-container">
                    <div class="user-invoice-main-first-container-fees">
                        ...
                        <div class="user-invoice-main-first-container-fees-second">
                            <p  style="cursor: pointer;" @click="downloadEmiFull(invoice?._id)" class="pi pi-download"> invoice</p>
                        </div>
                    </div>
                    <div class="user-invoice-main-first-container-fees-message">
                        <p class="mb-0">
                            ...
                            <span>
                                {{ invoice?.service || 'N/A' }} - <span> {{ }}Full Payment</span>
                            </span>
                        </p>
                    </div>
                            ...
                            <tr v-for="(i,index) in invoice?.emi">
                                ...
                                <td>
                                    <div class="user-invoice-action">
                                        ...
                                        <span  style="cursor: pointer;" @click="sendReminder(invoice._id,i.date,i.amount)" class="pi pi-bell">
                                            send Reminder
                                        </span>
                                    </div>
                                </td>
...
export default {
    ...
    async mounted() {
        activateMenu('admin-invoices', 'Invoice-EMI');
