                ...
                <div class="user-invoice-main-first-container">
                    <div class="user-invoice-main-first-container-fees">
                        ...
                        <div class="user-invoice-main-first-container-fees-second">
                            ...
                            <p  style="cursor: pointer;" @click="downloadFull(invoice?._id)" class="pi pi-download"> invoice</p>
                        </div>
                    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="user-invoice-action">
                                        ...
                                        <span style="cursor: pointer;" @click="setpaid(invoice._id)" class="pi pi-wallet">
                                            set paid
                                        </span>
                                        <span style="cursor: pointer;" @click="sendReminder(invoice)" class="pi pi-bell">
                                            send Reminder
                                        </span>
                                    </div>
                                </td>
