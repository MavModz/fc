  ...
  <div class="cnt">
    <div class="gallery-media-action">
      <div class="gallery-action">
        <NuxtLink v-if="userData.user.permission.gallery.image.view" class="span-red"  to="/subadmin/gallery/image">Images </NuxtLink>
        <NuxtLink v-if="userData.user.permission.gallery.video.view" class="span-grey ms-4" to="/subadmin/gallery/video" >Videos ({{ images.length }})</NuxtLink>
      </div>
      <label class="your-events-btn" v-if="userData.user.permission.gallery.image.add">
        <div>
        ...
        <template #list="s">
          <div class="gallery-row">
            <div class="gallery-col dropdown divhover2" v-for="(i, index) in s.items" :key="index">
              <div class="tooltip-gallery-cont" v-if="userData.user.permission.gallery.image.delete">
