<template>
    <div v-if="data.program.length > 0" class="program-section">
        ...
        <div v-if="data.program.length == 1" class="program-1-location">
            <div class="program-headerr">
                ...
                <div>
                    ...
                    <div v-if="!showFull">
                        <p v-html="truncateHtml(selectedProgram.eligibility_criteria, 300)"></p>
                        <button class="text-[#ff5757] mt-2" @click="showFull = true">Read More</button>
                    </div>
                    <div v-else>
                        <p v-html="selectedProgram.eligibility_criteria"></p>
                        <button class="text-[#ff5757] mt-2" @click="showFull = false">Read Less</button>
                    </div>
                </div>
            </div>
                ...
                <div class="flex">
                    ...
                    <div class="w-1/3 p-4 border-r">
                        <div v-for="(program, index) in data.program" :key="program._id" :class="[
                            'p-2 cursor-pointer m-2 ',
                            selectedProgram?._id === program._id ? 'bg-[#fff7f7] text-[#ff5757] border border-[#ff5757]' : 'hover:bg-gray-100 '
                    ...
                    <div class="w-2/3 p-4">
                        <div v-if="selectedProgram">
                            <h2 class="text-xl font-bold">{{ selectedProgram.program_name }}</h2>
                            <div v-if="!showFull">
                                <p v-html="truncateHtml(selectedProgram.eligibility_criteria, 300)"></p>
                                <button class="text-[#ff5757] mt-2" @click="showFull = true">Read More</button>
                            </div>
                            ...
                            <div>
                                <h3>Provinces</h3>
                                <p v-if="selectedProgram.program_province.length > 0"
